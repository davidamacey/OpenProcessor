...
```bash
./triton_bench \
  --images /mnt/nvm/REFERENCE_SAMPLE_PICTURES \
  --clients 64 \
  --duration 60 \
  --warmup 10 \
  --track all
...
```
--images string
    Directory containing test images (default: "/mnt/nvm/REFERENCE_SAMPLE_PICTURES")
...
```json
{
  ...
  "config": {
    "image_dir": "/mnt/nvm/REFERENCE_SAMPLE_PICTURES",
    "num_clients": 64,
    "duration": "60s",
    "warmup": 10
  },
...
- Check image directory exists: `ls /mnt/nvm/REFERENCE_SAMPLE_PICTURES`
