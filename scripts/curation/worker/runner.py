            ...
            try:
                ...
                if t.plate_status in _PENDING_DETECTION_ALIASES and not is_secondary:
                    ...
                    try:
                        ...
                        KB_STAGE_LPR_DURATION_SECONDS.labels(outcome='error').observe(
                            time.monotonic() - _lpr_t0
                        )
                        raise
                    cand = lpr_results[0] if lpr_results else None
                    KB_STAGE_LPR_DURATION_SECONDS.labels(
            ...
            if chunk:
                ...
                if plate_crops:
                    ...
                    try:
                        ...
                        KB_STAGE_A_GEMMA_VISIBLE_DURATION_SECONDS.labels(outcome='ok').observe(
                            time.monotonic() - _vis_t0
                        )
                    except Exception as exc:
                        KB_STAGE_A_GEMMA_VISIBLE_DURATION_SECONDS.labels(outcome='error').observe(
                            time.monotonic() - _vis_t0
                        )
                        logger.warning(
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    KB_STAGE_A_SAM_DURATION_SECONDS.labels(outcome='error').observe(
                ...
                KB_STAGE_A_SAM_DURATION_SECONDS.labels(
            ...
            if chunk:
                ...
                if combined_crops:
                    ...
                    try:
                        ...
                        KB_STAGE_B_GEMMA_VERIFY_DURATION_SECONDS.labels(outcome='ok').observe(
                            _gemma_elapsed
                        )
                        ...
                        KB_STAGE_B_GEMMA_VERIFY_DURATION_SECONDS.labels(outcome='error').observe(
