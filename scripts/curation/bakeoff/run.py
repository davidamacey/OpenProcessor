...
Example:
    .venv/bin/python -m scripts.curation.bakeoff.run \
        --dataset /data/curation_train_data/lpr_current \
        --backend ultralytics --weights /data/weights/lpr-nanov11-640.pt \
...
def main() -> int:
    ...
    p.add_argument('--vehicle-weights', default='/data/weights/yolo11n.pt')
