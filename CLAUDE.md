...
test_images/benchmark_all/  # REFERENCE + FACE_TEST_IMAGES combined
...
| REFERENCE Sample | `/data/REFERENCE_SAMPLE_PICTURES` | 1,138 | Real-world multi-category testing (YOLO) |
| Face Test Images | `/data/FACE_TEST_IMAGES` | varies | Bulk face ingestion testing |
...
docker compose exec yolo-api python /app/scripts/ingest_all_indexes.py \
    --images-dir /data/REFERENCE_SAMPLE_PICTURES \
    --max-images 500 --create-mosaics
```
