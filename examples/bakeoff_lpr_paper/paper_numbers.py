#!/usr/bin/env python3
"""Generate LaTeX numbers for an LPR bake-off paper from harness output.

Example / write-up tooling, not part of the bake-off harness: the headline
rows and public dataset names below are the license-plate example domain's.
...
pull it from the harness output. Run after every bake-off rerun::
    ...
    .venv/bin/python -m examples.bakeoff_lpr_paper.paper_numbers \\
...
def build_macros(matrix: dict, curated: str) -> str:
    ...
    out = ['% Auto-generated by examples/bakeoff_lpr_paper/paper_numbers.py -- do not hand-edit.']
    out += [
