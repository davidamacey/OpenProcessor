...
async def test_existing_crop_with_human_label_preserved_on_reingest() -> None:
    ...
    from src.services.curation.metrics import KB_INGEST_PRESERVED_HUMAN_LABEL
    ...
    before = _counter_value(KB_INGEST_PRESERVED_HUMAN_LABEL, field='region_label_source')
    before_text = _counter_value(KB_INGEST_PRESERVED_HUMAN_LABEL, field='region_text_source')
    ...
    after = _counter_value(KB_INGEST_PRESERVED_HUMAN_LABEL, field='region_label_source')
    after_text = _counter_value(KB_INGEST_PRESERVED_HUMAN_LABEL, field='region_text_source')
