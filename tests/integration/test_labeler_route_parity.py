...
1. Every path in the checked-in fixture
   ...
   executable ``/kb/...`` call sites, prefix-stripped and
...
After filtering, strip the leading ``/kb``, collapse ``${...}``
