...
async def test_three_failures_open_circuit() -> None:
    ...
    from src.services.curation.metrics import KB_SAM3_CIRCUIT_OPEN_TOTAL
    ...
    before = _metric_value(KB_SAM3_CIRCUIT_OPEN_TOTAL, host=host)
    ...
    after = _metric_value(KB_SAM3_CIRCUIT_OPEN_TOTAL, host=host)
...
async def test_bounded_retry_on_read_timeout() -> None:
    ...
    from src.services.curation.metrics import KB_SAM3_REQUEST_RETRIES_TOTAL
    ...
    before = _metric_value(KB_SAM3_REQUEST_RETRIES_TOTAL, host=host, outcome='success_after_retry')
    ...
    after = _metric_value(KB_SAM3_REQUEST_RETRIES_TOTAL, host=host, outcome='success_after_retry')
