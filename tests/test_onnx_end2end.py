...
def run_onnx_inference(model_path: str, img_path: str):
    ...
    for box, score, cls in zip(boxes, scores, classes):
        print(f"{str(box):<30} {score:<10.4f} {int(cls)}")
...
if __name__ == "__main__":
    # Default paths
    model_path = "/path/to/openprocessor/models/yolov11_small_end2end/1/model.onnx"
    img_path = "/data/REFERENCE_SAMPLE_PICTURES/DSC00002.JPG"
