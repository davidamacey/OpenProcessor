...
class TestRegionProvenance:
    def test_minimal_fields(self) -> None:
        F = get_region_fields()
        doc = region_provenance(DEFAULT_PROFILE.detector_model, DEFAULT_PROFILE.detector_version)
        assert doc[F.detector] == DEFAULT_PROFILE.detector_model
        assert doc[F.detector_version] == DEFAULT_PROFILE.detector_version
    ...
    def test_with_verifier(self) -> None:
        ...
        doc = region_provenance(
            DEFAULT_PROFILE.human_detector_name,
            DEFAULT_PROFILE.human_detector_version,
            verifier=DEFAULT_PROFILE.human_detector_name,
            verifier_version=DEFAULT_PROFILE.human_detector_version,
        )
        assert doc[F.verifier] == DEFAULT_PROFILE.human_detector_name
        assert doc[F.verifier_version] == DEFAULT_PROFILE.human_detector_version
