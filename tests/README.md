...
**Arguments:**
- `IMAGE_DIR`: Directory containing test images (default: `/mnt/nvm/REFERENCE_SAMPLE_PICTURES`)
...
# Full test (50 images)
bash tests/test_inference.sh /mnt/nvm/REFERENCE_SAMPLE_PICTURES small 50

# Test Track D batch variant
bash tests/test_inference.sh /mnt/nvm/REFERENCE_SAMPLE_PICTURES small 10 batch

# Test with nano model
bash tests/test_inference.sh /mnt/nvm/REFERENCE_SAMPLE_PICTURES nano 10
```
