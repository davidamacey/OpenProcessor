...
def _mistakenness_status() -> StrategyStatus:
    ...
    ``strategy_registry.py``'s live ``KB_SCORES_ENABLED``/``KB_SCORES_SHADOW``
    ...
    entries: list[ReviewSort] = [
        ...
        ReviewSort(
            ...
            description=(
                ...
                'unlike mistakenness this is NOT tied to KB_SCORES_ENABLED/SHADOW '
...
never stale relative to live ``KB_SCORES_ENABLED``/``KB_SCORES_SHADOW``."""
