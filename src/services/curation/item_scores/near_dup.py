...
validated at crop granularity. ``LEGACY_CROP_DUP_THRESHOLD`` (default 0.98,
...
def _threshold() -> float:
    try:
        return float(os.environ.get('LEGACY_CROP_DUP_THRESHOLD', str(DEFAULT_FRAME_DEDUP_THRESHOLD)))
    except ValueError:
