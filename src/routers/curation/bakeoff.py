...
OUT_DIR = Path(os.environ.get('OP_BAKEOFF_OUT_DIR', '/data/curation_train_data/bakeoff'))
...
RUNS_HOST_ROOT = Path(os.environ.get('OP_TRAIN_RUNS_ROOT', '/data/curation_train_data/runs'))
