...
|---------|------|--------|-------------|
| REFERENCE | `/data/REFERENCE_SAMPLE_PICTURES` | 1,137 | Real-world DSLR photos |
| FACE_TEST | `/data/FACE_TEST_IMAGES` | 200 | Face detection test images |
...
python scripts/ingest_all_indexes.py \
    --images-dirs "/data/REFERENCE_SAMPLE_PICTURES,/data/FACE_TEST_IMAGES,/path/to/openprocessor/test_images/ocr-synthetic,/path/to/openprocessor/test_images/ocr-real" \
    --max-images 5000 \
    --batch-size 16 \
    --workers 16 \
    --skip-clustering
