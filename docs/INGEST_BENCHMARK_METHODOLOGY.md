...
|---------|------|--------|-------------|
| REFERENCE | `/mnt/nvm/REFERENCE_SAMPLE_PICTURES` | 1,137 | Real-world DSLR photos |
...
python scripts/ingest_all_indexes.py \
    --images-dirs "/mnt/nvm/REFERENCE_SAMPLE_PICTURES,/mnt/nvm/FACE_TEST_IMAGES,/mnt/nvm/repos/OpenProcessor/test_images/ocr-synthetic,/mnt/nvm/repos/OpenProcessor/test_images/ocr-real" \
    --max-images 5000 \
    --batch-size 16 \
    --workers 16 \
    --skip-clustering
