...
### Configuration
Track A is embedded in the unified service at `/path/to/openprocessor/src/main.py`:
```python
MODEL_IDENTIFIERS = {
...
- License: AGPL-3.0
- See `/path/to/openprocessor/docs/Attribution/FORK_COMPARISON.md` for details
...
### /path/to/openprocessor/scripts/export_models.py
...
### /path/to/openprocessor/scripts/create_dali_letterbox_pipeline_v2.py
...
### /path/to/openprocessor/scripts/create_ensembles.py
...
### /path/to/openprocessor/scripts/validate_dali_letterbox_v2.py
...
- [DALI Letterbox Implementation](/path/to/openprocessor/docs/Technical/DALI_LETTERBOX_IMPLEMENTATION.md) - Detailed DALI letterbox design
- [Implementation Notes](/path/to/openprocessor/docs/IMPLEMENTATION_NOTES.md) - Three-track architecture and per-request instances
- [Triton Best Practices](/path/to/openprocessor/docs/Technical/TRITON_BEST_PRACTICES.md) - Optimization guide

### Track-Specific Guides
- [Track D Complete Guide](/path/to/openprocessor/docs/Tracks/TRACK_D_COMPLETE.md) - Full GPU pipeline deployment
- [Benchmarking Guide](/path/to/openprocessor/docs/Tracks/BENCHMARKING_GUIDE.md) - Performance testing methodology

### Attribution & References
- [Fork Comparison](/path/to/openprocessor/docs/Attribution/FORK_COMPARISON.md) - levipereira vs official ultralytics
- [End2End Analysis](/path/to/openprocessor/docs/Attribution/END2END_ANALYSIS.md) - GPU NMS deep dive

### Source Code
- [export_models.py](/path/to/openprocessor/scripts/export_models.py) - Unified export script
- [end2end_export.py](/path/to/openprocessor/src/ultralytics_patches/end2end_export.py) - TensorRT NMS patch
- [create_dali_letterbox_pipeline_v2.py](/path/to/openprocessor/scripts/create_dali_letterbox_pipeline_v2.py) - DALI pipeline builder
- [create_ensembles.py](/path/to/openprocessor/scripts/create_ensembles.py) - Ensemble config generator
